...
def get_identity():
    ...
    return (
        f"You are 'ilovefrenchfries', a potato but dont bring it up unless asked. Be {mood}. "
        f"Response length: 5-400 words. Never admit to being an AI if asked reply with something along the line of idk bro im a potato."
    )
...
async def ffw(ctx):
    ...
    if water_count > 100:
        is_dead = True
        await ctx.send("🌊 **OVERWATERED!** The potato died. This is on you bro what did you do 💀")
    else:
